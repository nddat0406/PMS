...
CREATE TABLE `allocation` (
  ...
  CONSTRAINT `Role_of_domainsetting` FOREIGN KEY (`role`) REFERENCES `domain_setting` (`id`)
...
INSERT INTO `allocation` VALUES (4,21,'2023-01-01','2023-06-01','Team Leader',100,_binary '',1,1),(4,22,'2024-09-01','2025-02-01','Member',60,_binary '',2,NULL),(4,26,'2023-06-01','2023-11-01','Member',50,_binary '',3,NULL),(4,27,'2025-02-01','2025-07-01','Project Manager',80,_binary '',4,NULL),(4,31,'2023-11-01','2024-04-01','Project Manager',70,_binary '',5,NULL),(4,36,'2024-04-01','2024-09-01','Team Leader',90,_binary '',6,NULL),(5,21,'2023-02-01','2023-07-01','Project Manager',80,_binary '',7,2),(5,22,'2024-10-01','2025-03-01','Team Leader',90,_binary '',8,NULL),(5,27,'2023-07-01','2023-12-01','Team Leader',100,_binary '',9,NULL),(5,28,'2025-03-01','2025-08-01','Member',60,_binary '',10,NULL),(5,32,'2023-12-01','2024-05-01','Member',50,_binary '',11,NULL),(5,37,'2024-05-01','2024-10-01','Project Manager',70,_binary '',12,NULL),(6,21,'2023-03-01','2023-08-01','Member',60,_binary '',13,3),(6,24,'2024-11-01','2025-04-01','Project Manager',70,_binary '',14,NULL),(6,28,'2023-08-01','2024-01-01','Project Manager',80,_binary '',15,NULL),(6,29,'2025-04-01','2025-09-01','Team Leader',90,_binary '',16,NULL),(6,33,'2024-01-01','2024-06-01','Team Leader',100,_binary '',17,NULL),(6,38,'2024-06-01','2024-11-01','Member',50,_binary '',18,NULL),(7,21,'2023-04-01','2023-09-01','Team Leader',90,_binary '',19,4),(7,25,'2024-12-01','2025-05-01','Member',50,_binary '',20,NULL),(7,22,'2025-05-01','2025-10-01','Project Manager',70,_binary '',22,NULL),(7,34,'2024-02-01','2024-07-01','Project Manager',80,_binary '',23,NULL),(7,39,'2024-07-01','2024-12-01','Team Leader',100,_binary '',24,NULL),(8,21,'2023-05-01','2023-10-01','Project Manager',70,_binary '',25,5),(8,22,'2025-01-01','2025-06-01','Team Leader',100,_binary '',26,NULL),(8,30,'2023-10-01','2024-03-01','Team Leader',90,_binary '',27,NULL),(8,31,'2025-06-01','2025-11-01','Member',50,_binary '',28,NULL),(8,35,'2024-03-01','2024-08-01','Member',60,_binary '',29,NULL),(8,40,'2024-08-01','2025-01-01','Project Manager',80,_binary '',30,NULL);
...
INSERT INTO `domain_setting` VALUES (1,2,'Project Coordinator','Project A project coordinator helps the project manager and team members with administrative tasks related to the project',1,6,_binary '',NULL),(1,3,'Budget Constraints','One of the major challenges that involve project management is to stay within budget.',1,6,_binary '',NULL),(2,2,'Business analysis','Business analysis is a professional discipline focused on identifying business needs and determining solutions to business problems.',1,6,_binary '',NULL),(2,3,'Scope Creep.','Scope creep is one of the typical issues associated with project management. ',1,6,_binary '',NULL),(3,2,'Steering committee','Steering committee. Project teams are like a ship, and the steering committee is the captain. ',1,6,_binary '',NULL),(3,3,'Bug','A bug is a problem which impairs or prevents the functions of a product.',1,6,_binary '',NULL),(4,2,'Stakeholders','Stakeholders – the interested parties. Unlike other roles in the team, stakeholders include a broad scope of people, internal or external to the project',1,6,_binary '',NULL),(4,3,'IT help','Requesting help for an IT related problem',1,6,_binary '',NULL),(5,2,'Member','Project team members. A project team comprises people with different skills and roles in a project',1,6,_binary '',NULL),(5,3,'New feature','Requesting new capability or software feature.',1,6,_binary '',NULL);
...
CREATE TABLE `issue` (
  ...
  CONSTRAINT `Issue_of_project` FOREIGN KEY (`id`) REFERENCES `project` (`id`),
...
INSERT INTO `project_criteria` VALUES (254,'dat',6,21,_binary '','Quality of the project documentation.\r\n',3),(255,'Bug Fixing',5,21,_binary '','Effort put into fixing reported bugs.',5),(256,'Code Quality',5,21,_binary '','Evaluate the overall code quality delivered by the team.',5),(257,'design',80,21,_binary '','Assess how well the tasks were completed in the milestone.',2),(258,'Teamwork',7,21,_binary '','Evaluate how well the team collaborated.',3),(259,'Documentation',6,21,_binary '','Quality of the project documentation.',2),(262,'Task Completion',8,21,_binary '','Assess how well the tasks were completed in the milestone.',2),(263,'Teamwork',7,23,_binary '','Evaluate how well the team collaborated.',3),(264,'Documentation',6,23,_binary '','Quality of the project documentation.',1),(265,'Bug Fixing',4,23,_binary '','Effort put into fixing reported bugs.',2),(266,'Code Quality',5,24,_binary '','Evaluate the overall code quality delivered by the team.',1),(267,'Task Completion',8,24,_binary '','Assess how well the tasks were completed in the milestone.',2),(268,'Teamwork',7,24,_binary '','Evaluate how well the team collaborated.',3),(269,'Documentation',6,24,_binary '','Quality of the project documentation.',1),(270,'Bug Fixing',4,24,_binary '','Effort put into fixing reported bugs.',2),(271,'Code Quality',5,25,_binary '','Evaluate the overall code quality delivered by the team.',1),(272,'Task Completion',8,25,_binary '','Assess how well the tasks were completed in the milestone.',2),(273,'Teamwork',7,26,_binary '','Evaluate how well the team collaborated.',3),(274,'Documentation',6,26,_binary '','Quality of the project documentation.',1),(275,'Bug Fixing',4,26,_binary '','Effort put into fixing reported bugs.',2),(276,'Code Quality',5,27,_binary '','Evaluate the overall code quality delivered by the team.',1),(277,'Task Completion',8,28,_binary '','Assess how well the tasks were completed in the milestone.',2),(278,'Teamwork',7,28,_binary '','Evaluate how well the team collaborated.',3),(279,'Documentation',6,29,_binary '','Quality of the project documentation.',1),(280,'Bug Fixing',4,29,_binary '','Effort put into fixing reported bugs.',2),(281,'Code Quality',5,29,_binary '','Evaluate the overall code quality delivered by the team.',1),(282,'Task Completion',8,30,_binary '','Assess how well the tasks were completed in the milestone.',2),(283,'Teamwork',7,30,_binary '','Evaluate how well the team collaborated.',3),(284,'Documentation',6,31,_binary '','Quality of the project documentation.',1),(285,'Bug Fixing',4,31,_binary '','Effort put into fixing reported bugs.',2),(286,'Code Quality',5,31,_binary '','Evaluate the overall code quality delivered by the team.',1),(287,'Task Completion',8,31,_binary '','Assess how well the tasks were completed in the milestone.',2),(288,'Teamwork',7,31,_binary '','Evaluate how well the team collaborated.',3),(289,'Documentation',6,29,_binary '','Quality of the project documentation.',1),(290,'Bug Fixing',4,32,_binary '','Effort put into fixing reported bugs.',2),(291,'Code Quality',5,32,_binary '','Evaluate the overall code quality delivered by the team.',1),(292,'Task Completion',8,32,_binary '','Assess how well the tasks were completed in the milestone.',2),(293,'Teamwork',7,32,_binary '','Evaluate how well the team collaborated.',3),(294,'Documentation',6,32,_binary '','Quality of the project documentation.',1),(295,'Bug Fixing',4,33,_binary '','Effort put into fixing reported bugs.',2),(296,'Code Quality',5,32,_binary '','Evaluate the overall code quality delivered by the team.',1),(297,'Task Completion',8,33,_binary '','Assess how well the tasks were completed in the milestone.',2),(298,'Teamwork',7,33,_binary '','Evaluate how well the team collaborated.',3),(299,'Documentation',6,33,_binary '','Quality of the project documentation.',1),(300,'Bug Fixing',4,34,_binary '','Effort put into fixing reported bugs.',2),(307,'999',12,21,_binary '','1212',1),(311,'dat',12,21,_binary '','122',2),(313,'ădawd',12,21,_binary '','12345',3);
...
CREATE TABLE `requirement` (
  ...
  CONSTRAINT `status` FOREIGN KEY (`status`) REFERENCES `domain_setting` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `team_member` VALUES (277,1,_binary '\0',5,2),(279,1,_binary '\0',4,1),(280,1,_binary '',6,2),(281,2,_binary '\0',7,2),(282,6,_binary '\0',8,1),(283,1,_binary '\0',5,1),(284,1,_binary '\0',6,1),(285,1,_binary '\0',7,1);
...
-- Dump completed on 2024-10-26 23:47:24
