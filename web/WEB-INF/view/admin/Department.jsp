                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="Domain" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th name="department.id" sortBy="asc" class="sortTableHead">Id&nbsp;<i class="fa fa-sort sort-icon"></i></th>
                                                    <th name="department.code" sortBy="asc" class="sortTableHead">Code&nbsp;<i class="fa fa-sort sort-icon"></i></th>
                                                    <th name="department.name" sortBy="asc" class="sortTableHead">Name&nbsp;<i class="fa fa-sort sort-icon"></i></th>
                                                    <th name="department.parent" sortBy="asc" class="sortTableHead">Parent&nbsp;<i class="fa fa-sort sort-icon"></i></th>
                                                    <th name="department.status" sortBy="asc" class="sortTableHead">Status&nbsp;<i class="fa fa-sort sort-icon"></i></th>
                                                        <c:if test="${loginedUser.role==1}">
                                                        <th>Action</th>
                                                        </c:if>
                                                </tr>
