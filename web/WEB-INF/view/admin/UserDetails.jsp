                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-right flex-grow-1">
                            <form id="navbar-search"
                                  class="navbar-form search-form float-start mt-1 p-0 position-relative me-3 d-none d-md-block me-3">
                                <input value="" class="form-control" value="Search here..." type="text">
                                <button type="button" class="btn btn-secondary"><i class="fa fa-search"></i></button>
                            </form>

                            <div id="navbar-menu" class="float-end">
                                <ul class="nav navbar-nav d-inline-block">
                                    <li class="d-inline-block"><a href="app-events.html"
                                                                  class="icon-menu d-none d-sm-block d-md-none d-lg-block"><i
                                                class="fa fa-calendar"></i></a></li>
                                    <li class="d-inline-block"><a href="app-chat.html"
                                                                  class="icon-menu d-none d-sm-block"><i class="fa fa-comments"></i></a></li>
                                    <li class="d-inline-block"><a href="app-inbox.html"
                                                                  class="icon-menu d-none d-sm-block"><i class="fa fa-envelope"></i><span
                                                class="notification-dot"></span></a></li>
                                    <li class="dropdown d-inline-block">
                                        <a class="dropdown-toggle icon-menu" href="#" role="button" id="notificationsBtn"
                                    ...
                                    <li class="dropdown d-inline-block">
                                        <a class="dropdown-toggle icon-menu" href="#" role="button" id="userMenu"
                                        ...
                                        <ul class="dropdown-menu user-menu menu-icon list-unstyled">
                                            ...
                                            <li><a href="javascript:void(0);"><i class="fa fa-sliders fa-rotate-90"></i>
                                            ...
                                            <li><a href="javascript:void(0);"><i class="fa fa-credit-card"></i>
                                                    <span>Payments</span></a></li>
                                            <li><a href="javascript:void(0);"><i class="fa fa-print"></i>
                                                    <span>Invoices</span></a></li>
                                            <li><a href="javascript:void(0);"><i class="fa fa-refresh"></i>
                                                    <span>Renewals</span></a></li>
                                        </ul>
                                    </li>
                                    <li class="d-inline-block"><a href="page-login.html" class="icon-menu"><i
                ...
                <div id="left-sidebar" class="sidebar">
                    <div class="user-account p-3 mb-3">
                        <div class="d-flex mb-3 pb-3 border-bottom align-items-center">
                            <img src="${pageContext.request.contextPath}/assets/images/user.png" class="avatar lg rounded me-3" alt="User Profile Picture">
                    ...
                    <ul class="nav nav-tabs text-center mb-2" role="tablist">
                        ...
                        <li class="nav-item flex-fill"><a class="nav-link active" data-bs-toggle="tab" href="#project_menu" role="tab">Project</a></li>
                    ...
                    <div class="tab-content px-0">
                        ...
                        <div class="tab-pane active" id="project_menu">
                            <nav class="sidebar-nav">
                                <ul class="main-menu metismenu list-unstyled">
                                    ...
                                    <li class="active mm-active">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="active mm-show"><a href="client-add.html">Add Clients</a></li>
