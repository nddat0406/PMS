...
<body>
            ...
            <div id="main-content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Search Form -->
                            <form action="${pageContext.request.contextPath}/admin/defectlist" method="POST">
                                    ...
                                    <tbody>
                                        <c:forEach items="${defects}" var="defect">
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Edit Button -->
                                                    <a href="${pageContext.request.contextPath}/admin/defectdetail?id=${defect.id}" 
                                                    ...
                                                    <c:if test="${defect.status != 4}">
                                                        <form action="${pageContext.request.contextPath}/admin/defectlist" 
    ...
    <!-- Delete Form -->
    <form id="deleteForm" action="${pageContext.request.contextPath}/admin/defectlist" method="POST" style="display: none;">
