<%-- 
    Document   : issue-manage
    Created on : Nov 6, 2024, 5:03:46 AM
    Author     : Admin
--%>
                        ...
                        <div class="modal-body">
                            <form id="issueForm" action="${pageContext.request.contextPath}/issue" method="post">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="projectId" id="modalProjectId" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Assignee ID <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" name="assigneeId" 
                                                   id="modalAssigneeId" required min="1">
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.edit-issue').click(function () {
                    ...
                    $('#modalAssigneeId').val(row.find('td:eq(6)').text());
            ...
            function validateForm() {
                ...
                const requiredFields = {
                    ...
                    'modalProjectId': 'Project ID is required',
                    'modalType': 'Type is required',
                    'modalAssigneeId': 'Assignee ID is required',
                ...
                // Length validations
                if ($('#modalTitle').val().length > 100) {
                    showError('modalTitle', 'Title must be less than 100 characters');
                    isValid = false;
                }

                if ($('#modalDescription').val().length > 1000) {
                ...
                if (dueDate < endDate) {
                    showError('modalDueDate', 'Due date cannot be earlier than end date');
                    isValid = false;
                }
