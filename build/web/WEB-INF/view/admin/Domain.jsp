...
<html lang="en">
    ...
    <style>
        .Domain-actions {
            text-align: center; /* Canh gi?a cc nt b?m */
        }

        .Domain-actions form {
            display: inline-block; /* Hi?n th? cc form theo hng ngang */
            margin-right: 5px; /* Thm kho?ng cch gi?a cc nt */
        }
                        ...
                        <div class="d-flex flex-grow-1 align-items-center">
                            <div class="d-flex">
                                ...
                                <form id="navbar-search" class="navbar-form search-form position-relative d-none d-md-block">
                                    <input value="search" class="form-control" placeholder="Search here..." type="text">
                                ...
                                <ul class="main-menu metismenu list-unstyled">
                                    ...
                                    <li class="active mm-active">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="active mm-show"><a href="project-list.html">Domain</a>
                                            </li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="Domain-actions">
                                                            <div class="btn-group">
                                                                ...
                                                                <form action="domain?action=delete" method="get" onsubmit="return confirm('Are you sure you want to delete this domain?');" style="display: inline-block;">
